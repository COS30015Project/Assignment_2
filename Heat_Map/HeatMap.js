function init() {
    ...
    function dragstart() {
      cursor.select(".cursor").style("fill", "#D9886C");
    }
  
    function dragend() {
      cursor.select(".cursor").style("fill", "");
    }
  
    // Read data and perform further operations here
    Promise.all([
      ...
      // Continue with your code for drawing the map based on processedData
    });
