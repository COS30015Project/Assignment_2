document.addEventListener('DOMContentLoaded', function () {
        ...
        d3.csv('us_migration_data.csv').then(function (data) {
            ...
            svg.selectAll('path')
                ...
                .on('mousemove', function (d) {
                    handleMousemove(d, processedData, tooltip);
                })
            ...
            svg.on('mousemove', function () {
                handleTooltipPosition(this, tooltip);
            });
        });
    });

    function handleMousemove(d, processedData, tooltip) {
        if (d.properties && d.properties.NAME) {
            ...
            if (stateInfo) {
                ...
                handleTooltipPosition(d, tooltip);
            }
        }
    }
    ...
    function handleTooltipPosition(d, tooltip) {
        // Update the tooltip's position.
